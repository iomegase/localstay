...
describe('normalizePracticalBlocks', () => {
  it('trims titles, nulls empty body/photo, drops untitled blocks, reindexes sort_order', () => {
    const result = normalizePracticalBlocks([
      { title: '  Plage  ', body: 'À 5 min', icon: 'star', photo_url: '', video_url: null, sort_order: 9 },
      { title: '   ', body: 'orphan', icon: 'info', photo_url: null, video_url: null, sort_order: 3 },
      { title: 'Vélos', body: '   ', icon: 'bike', photo_url: 'https://x/y.webp', video_url: null, sort_order: 1 },
    ])

    expect(result).toEqual([
      { title: 'Plage', body: 'À 5 min', icon: 'star', photo_url: null, video_url: null, sort_order: 0 },
