...
describe('WeatherWidget — 025-weather', () => {
  ...
  it('renders the Open-Meteo forecast data inside the new widget design', async () => {
    ...
    expect(screen.getByTestId('weather-widget-nav').firstElementChild).toBe(screen.getByTestId('weather-widget-clock'))
    expect(screen.getByTestId('weather-widget-nav').lastElementChild).toBe(screen.getByTestId('weather-widget-menu-slot'))
    expect(screen.getByTestId('weather-widget-content')).toHaveClass('flex-1', 'justify-center')
    expect(screen.getByTestId('weather-widget-main')).toHaveClass('shrink-0')
    expect(screen.getByTestId('weather-widget-main')).not.toHaveClass('flex-1', 'justify-center')
    ...
    expect(screen.getByTestId('weather-widget-forecast-panel')).toHaveClass('h-[196px]')
    const daily = screen.getByTestId('weather-widget-daily')
    expect(daily).toHaveClass('space-y-1.5')
