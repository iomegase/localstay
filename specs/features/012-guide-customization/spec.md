...
- `/le-logement` affiche un guide logement en trois pages : page 1 avec le nom du logement, la photo de couverture et le message Owner ; page 2 avec les informations pratiques courantes dont adresse, vidéo du logement, Wi-Fi, parking, équipements, règlement, services et urgences ; page 3 avec les consignes de départ, les poubelles et les blocs pratiques personnalisés. La vidéo de présentation du logement, lorsqu'elle existe, est rendue en page 2 entre "Adresse" et "Parking". Chaque page affichée ajuste sa hauteur au contenu actif avec un espace bas modéré pour la navigation mobile, sans hauteur viewport forcée ni réserve de hauteur issue des pages masquées.
- `/nos-recommandations` affiche les recommandations locales groupées par catégorie puis une section "À découvrir ailleurs" groupée par City, avec le commentaire Owner lorsqu'il est renseigné. Les titres de groupes sont affichés en semi-bold. Les titres de City de cette section contractent le préfixe "À" avec les noms commençant par "Les" : "Les Contamines-Montjoie" devient "Aux Contamines-Montjoie".
