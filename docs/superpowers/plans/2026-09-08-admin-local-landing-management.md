...
Implementation for Tasks 1–8 is present. Checked steps record delivered code and
offline checks; they do not claim that a database migration was executed.
Task 2 steps 5–6 remain deployment gates (backfill twice, verify links, enforce
the required relation). Task 7 step 7 and Task 8 step 5 require the opt-in local
Admin/City fixture. Task 8 step 4 was run, but full Jest retains baseline failures
and the production build is not yet validated. See
`docs/verification/048-admin-local-landing-management.md` for exact results.
The spec stays `approved` while those operational gates remain open.
...
- [x] **Step 2: Run the validation test and confirm the missing-module failure**
...
- [x] **Step 3: Implement strict DTO and Zod schemas**
...
- [x] **Step 4: Write and run publication-policy tests**
...
- [x] **Step 1: Write a failing schema/backfill integrity test**
...
- [x] **Step 2: Extend Prisma with the approved target models**
...
- [x] **Step 3: Generate the structural migration**
...
- [x] **Step 4: Implement an idempotent TypeScript backfill**
...
- [x] **Step 7: Run the focused integration test and commit**
...
- [x] **Step 2: Implement public and Admin read functions**
...
- [x] **Step 3: Implement create, update, toggle and delete transactions**
...
- [x] **Step 4: Move review queries to the destination relation**
...
- [x] **Step 1: Write failing contract tests for authentication and responses**
...
- [x] **Step 2: Implement the collection route**
...
- [x] **Step 3: Implement content, publication and deletion routes**
...
- [x] **Step 2: Load persisted DTOs in all three page modules**
...
- [x] **Step 3: Adapt public components without changing their visual contract**
...
- [x] **Step 4: Adapt metadata and JSON-LD helpers**
...
- [x] **Step 5: Run public tests and commit**
...
- [x] **Step 1: Write failing sitemap and hub tests**
...
- [x] **Step 2: Make sitemap generation asynchronous**
...
- [x] **Step 3: Feed hub components with published destinations from the server**
...
- [x] **Step 2: Add the approved Shadcn primitives**
...
- [x] **Step 3: Load the new Admin DTO in the Server Component**
...
- [x] **Step 4: Implement the responsive destination table**
...
- [x] **Step 5: Implement the inline three-accordion editor**
...
- [x] **Step 6: Implement Add city and group deletion flows**
...
- [x] **Step 1: Prove no public/Admin runtime imports the static catalogue**
...
- [x] **Step 2: Update superseded tests to use persisted DTO fixtures**
...
- [x] **Step 3: Update the traceability matrix**
...
- [x] **Step 6: Commit traceability and cleanup**
