...
| AC-03-06 | La publication admin renseigne `status = published`, `published_at` et rend l'article publiable | `src/app/api/admin/blog/[id]/publish/route.ts`<br>`src/features/blog/queries/admin-blog.ts` | `tests/integration/blog.AC-03-06.publish-flow.test.ts` | ✅ done |
...
| AC-04-01 | Gemini retourne une proposition structurée `title/excerpt/markdown/SEO` | `src/app/api/admin/blog/[id]/generate/route.ts`<br>`src/features/blog/services/gemini-draft.ts`<br>`src/features/blog/queries/admin-blog.ts` | `tests/contract/blog.AC-04-01.gemini-generate.test.ts` | ✅ done |
