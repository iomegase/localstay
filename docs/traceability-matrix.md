...
| AC-01-02/AC-01-03/AC-04-01 | Accès départ demande le GPS au clic, affiche route Mapbox ou marker départ si GPS refusé | `src/features/trail-navigation/components/TrailAccessActions.tsx` | `tests/unit/trail-navigation.actions.test.tsx` | ✅ done |
...
| AC-01-05/BR-01/BR-02 | Fiche randonnée sans Google Maps, Apple Maps, `Itinéraire` ni `Réserver` | `src/features/trail-navigation/components/TrailPoiDetailBody.tsx`<br>`src/features/trail-navigation/components/TrailAccessActions.tsx` | `tests/integration/trail-navigation.public-detail.test.tsx` | ✅ done |
| AC-02-02/AC-02-03 | Route `/guide/[city-slug]/rando/[trail-slug]/start` affiche carte Mapbox outdoor, trace et markers | `src/app/(public)/guide/[city-slug]/rando/[trail-slug]/start/page.tsx`<br>`src/features/trail-navigation/components/TrailNavigationMap.tsx` | `tests/unit/trail-navigation.start-map.test.tsx` | ✅ done |
| AC-02-04/AC-03-01/AC-03-05 | Mode start garde le tracé sans GPS, affiche position si consentie et états GPS explicites | `src/features/trail-navigation/components/TrailNavigationMap.tsx` | `tests/unit/trail-navigation.start-map.test.tsx` | ✅ done |
| AC-03-02/AC-03-03/AC-03-04 | Distance au tracé, off-track et progression indicative calculés côté client | `src/features/trail-navigation/lib/geo.ts`<br>`src/features/trail-navigation/components/TrailNavigationMap.tsx` | `tests/unit/trail-navigation.geo.test.ts`<br>`tests/unit/trail-navigation.start-map.test.tsx` | ✅ done |
