...
| AC-02-02/AC-02-03/AC-04-01 | Route `/guide/[city-slug]/rando/[trail-slug]/start` affiche carte Mapbox outdoor, trace et markers en état `ready` sans lancer `watchPosition` | `src/app/(public)/guide/[city-slug]/rando/[trail-slug]/start/page.tsx`<br>`src/features/trail-navigation/components/TrailNavigationMap.tsx` | `tests/unit/trail-navigation.start-map.test.tsx` | ✅ done |
