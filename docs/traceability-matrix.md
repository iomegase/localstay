...
| AC-04-01 | Favoris locaux → cards verticales compactes sans accordéon + ouverture en panneau modal avec backdrop, sans navigation d'URL + footer actions modal en pilules alignées sur une ligne, sans réservation | `src/app/(public)/mes-favoris/page.tsx`<br>`src/features/public-menu/components/FavoritesList.tsx`<br>`src/features/public-menu/components/FavoritePoiModal.tsx`<br>`src/features/categories/components/ActionButtons.tsx` | `tests/integration/favorites.modal.test.tsx`<br>`tests/integration/favorite-poi-modal.shell.test.tsx`<br>`tests/unit/categories.AC-01-02-03.action-buttons.test.tsx` | ✅ done |
| BR-09 | Nom produit MyStay + libellés publics `Bienvenue`, `Vos favoris`, `Les recommandations de {owner.name}` + bouton `Guide` contextuel sur `/guide/[city-slug]` + item actif `#bd9254` + items inactifs `#6f7480` + bottom nav complet transparent pendant le scroll puis visible à l'arrêt | `src/app/(public)/layout.tsx`<br>`src/features/city-guide/components/PublicBottomNav.tsx`<br>`src/features/city-guide/components/PublicMenu.tsx`<br>`src/features/public-menu/lib/lodging-mode.ts` | `tests/unit/public-layout.mockup-menu.test.tsx`<br>`tests/unit/public-bottom-nav.test.tsx` | ✅ done |
...
| AC-02-01 | Fiche logement publique premium avec galerie, facts, équipements et recommandations | `src/app/(public)/guide/[city-slug]/logements/[lodging-slug]/page.tsx`<br>`src/features/lodging-showcase/components/LodgingGallery.tsx`<br>`src/features/lodging-showcase/components/LodgingFacts.tsx`<br>`src/features/lodging-showcase/components/AmenitiesGrid.tsx`<br>`src/features/lodging-showcase/components/OwnerRecommendationsBlock.tsx` | `tests/integration/lodging-showcase.public-pages.test.tsx` | ✅ done |
...
| AC-03-02 | CTA contact public préremplit `lodging_id` vers le formulaire Owner | `src/app/(public)/guide/[city-slug]/logements/[lodging-slug]/page.tsx` | `tests/integration/lodging-showcase.public-pages.test.tsx` | ✅ done |
...
| AC-04-01 | Bloc "Séjourner à [City]" visible sur le Guide ville si logements publiés | `src/app/(public)/guide/[city-slug]/page.tsx`<br>`src/features/lodging-showcase/components/LodgingCitySection.tsx`<br>`src/features/lodging-showcase/queries/public-lodgings.ts` | `tests/integration/lodging-showcase.public-pages.test.tsx` | ✅ done |
...
| AC-06-02 | Admin publie une fiche en revue | `src/app/api/admin/lodgings/public-profiles/[profileId]/publish/route.ts`<br>`src/features/lodging-showcase/queries/admin-public-profiles.ts` | `tests/contract/lodging-showcase.admin-api.test.ts` | ✅ done |
| AC-06-03 | Admin demande correction avec note de revue | `src/app/api/admin/lodgings/public-profiles/[profileId]/request-changes/route.ts`<br>`src/features/lodging-showcase/queries/admin-public-profiles.ts` | `tests/contract/lodging-showcase.admin-api.test.ts` | ✅ done |
| AC-06-04 | Admin archive une fiche publique | `src/app/api/admin/lodgings/public-profiles/[profileId]/archive/route.ts`<br>`src/features/lodging-showcase/queries/admin-public-profiles.ts` | `tests/contract/lodging-showcase.admin-api.test.ts` | ✅ done |
