...
| AC-05-05/AC-05-06 | Bloc `live` Vercel se dégrade proprement et lit un flux récent supporté quand disponible | `src/app/admin/analytics/page.tsx`<br>`src/app/api/admin/analytics/live/route.ts`<br>`src/features/admin-analytics/queries/dashboard.ts`<br>`src/features/admin-analytics/services/vercel-live.ts` | `tests/integration/admin-analytics.page.test.tsx`<br>`tests/contract/admin-analytics.api.test.ts`<br>`tests/unit/admin-analytics.dashboard-queries.test.ts`<br>`tests/unit/admin-analytics.vercel-live.test.ts` | ✅ done |
