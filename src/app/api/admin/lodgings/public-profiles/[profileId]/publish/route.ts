...
import { publishLodgingProfile } from '@/features/lodging-showcase/queries/admin-public-profiles'
...
export async function POST(
  ...
  const profile = await publishLodgingProfile(parsed.data.profileId)
  if (!profile) {
