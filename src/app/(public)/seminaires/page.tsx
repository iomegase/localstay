        ...
        <section className={`${marketingContainerClass} pt-0 sm:pt-8`}>
          ...
          >
            <div className="relative z-10 my-auto max-w-[650px]">
              ...
              <p className="mt-7 max-w-[590px] text-sm leading-[1.72] text-slate-600 lg:text-[15px]">
                MyStay organise des séminaires à Saint-Gervais-les-Bains et dans le Pays du
                Mont-Blanc : hébergement, salles de réunion, repas, transferts et temps collectifs.
                Un seul interlocuteur coordonne le séjour, du premier brief au départ de votre équipe.
              </p>
              <div className="mt-[30px] flex flex-col items-start gap-6 sm:flex-row sm:items-center">
                <a className={marketingPrimaryButtonClass} href={contactHref}>
