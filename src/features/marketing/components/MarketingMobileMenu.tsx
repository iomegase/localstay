      ...
      <Dialog.Trigger asChild>
        ...
        >
          <span
            ...
            "
          >
            <span className="block h-[1.5px] w-7 rounded-full bg-current" />
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content
          className="
            ...
            data-[state=closed]:animate-out
            data-[state=closed]:fade-out-0
            data-[state=closed]:slide-out-to-right-8
            ...
            sm:left-auto
            sm:right-5
            sm:w-[min(430px,calc(100vw-40px))]
            sm:rounded-[36px]
            sm:px-9
            sm:pb-9
            sm:pt-7
              ...
              <Dialog.Close asChild>
                <Link
                  ...
                  className="
                    ...
                    font-bold
                    text-white
                    shadow-[0_16px_36px_rgba(15,23,42,0.18)]
                    transition-colors
                    hover:bg-pink-600
                    focus-visible:outline
                    focus-visible:outline-2
