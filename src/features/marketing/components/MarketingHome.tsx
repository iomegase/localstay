      ...
      >
        ...
        >
          ...
          <div
            ...
            className="relative z-10 flex min-h-[720px] flex-col px-7 pb-[34px] pt-[54px] text-white min-[431px]:min-h-[690px] min-[761px]:min-h-[590px] min-[761px]:px-[46px] min-[761px]:pb-[54px] min-[761px]:pt-[76px] min-[1051px]:min-h-[700px] min-[1051px]:px-16 xl:min-h-[560px] xl:px-[52px] xl:pb-[43px] xl:pt-[60px]"
          >
