      ...
      <div className="mx-auto w-full max-w-[944px]">
        <div className={compact ? 'mb-4' : 'mb-4 md:mb-6 md:flex md:items-end md:justify-between md:gap-10 xl:mb-7'}>
          ...
          <h2 className={compact
            ? 'mt-2 max-w-[600px] text-[16px] font-semibold leading-[1.05] tracking-[-0.04em] text-slate-800'
        ...
        <dl
          ...
          className={compact
            ? 'grid grid-cols-2 overflow-hidden rounded-[20px] border border-slate-200/70 bg-white'
            : 'grid grid-cols-2 overflow-hidden rounded-[20px] border border-slate-200/70 bg-white md:grid-cols-5 md:divide-x md:divide-slate-100'}
        >
