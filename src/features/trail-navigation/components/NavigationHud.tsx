...
export function NavigationHud({
  ...
  return (
    <div
      ...
      className={`absolute inset-x-3 bottom-3 rounded-[26px] bg-white/95 px-5 py-3.5 shadow-[0_10px_36px_-10px_rgba(18,18,18,0.28)] backdrop-blur ${pulse ? 'animate-pulse' : ''}`}
    >
      <div className="flex items-center justify-between gap-3">
        ...
        <button
          ...
          className="ml-1 flex h-7 w-7 items-center justify-center rounded-full bg-gray-100 text-charcoal shadow-sm active:scale-95 transition-transform"
        >
